...
# 创建 property_experiment.ipynb 文件的内容
notebook_content = {
    "cells": [
        {
            "cell_type": "markdown",
            ...
            "source": [
                "<a href=\"https://colab.research.google.com/github/ailouislu/property-forecast-system/blob/main/notebooks/property_experiment.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
            ]
        },
        {
            "cell_type": "markdown",
...
# 将内容写入文件
with open('e:/Next.js/realEstate/nzlouis-property-ai-engine/notebooks/property_experiment.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook_content, f, ensure_ascii=False, indent=2)

print("成功创建 property_experiment.ipynb 文件")